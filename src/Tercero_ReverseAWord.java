...
public class Tercero_ReverseAWord {
	 ...
	 * This is another classical Java programming question. You can reverse String
	 * in various way in Java but two programming technique is used to do e.g.
	 * Iteration and Recursion. Try solving this problem using Iteration first by
	 * using Java’s arithmetic operator and than look to implement a recursive
	 * solution. Here is one way to reverse String in Java without using
	 * StringBuffer.
	 * 
	 * 
	 * Read more:
